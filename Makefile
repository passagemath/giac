...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/config.h.in \
	...
	config/texinfo.tex config/ylwrap mkinstalldirs
...
CXXFLAGS = -g -O2  -U_GLIBCXX_ASSERTIONS -DUSE_OBJET_BIDON -fno-strict-aliasing -DGIAC_GENERIC_CONSTANTS -DTIMEOUT -DHAVE_LIBMICROPYTHON -fpermissive -DQUICKJS
CYGPATH_W = echo
DATADIRNAME = share
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
...
FLTK_LIBS = -lfltk_images -ljpeg -lpng -lz -lfltk -lfltk_gl -lXrender -lXext -lXft -lfontconfig -lXinerama -lX11 -lGL -lsamplerate -lglpk -lao -llapack -lblas -ldl -lpng16 -lm -lecm -lmpfi -lmpfr -lgmp  
GENCAT = gencat
GINSH_LIBS = -lreadline -lncurses -lsamplerate -lglpk -lao -llapack -lblas -ldl -lpng16 -lm -lecm -lmpfi -lmpfr -lgmp 
GLIBC2 = yes
GLIBC21 = yes
GLPK_LIBS = 
GMPXX_LIBS = -lgmpxx
...
LIBINTL = 
LIBOBJS = 
LIBS = -lrt -lpthread -lnauty -lcliquer -lsamplerate -lglpk -lao -llapack -lblas -ldl -lpng16 -lm -lecm -lmpfi -lmpfr -lgmp 
LIBTERMCAP = -lncurses
...
YACC = yacc
YFLAGS = 
abs_builddir = /home/parisse/builddeb/giac-1.9.0
abs_srcdir = /home/parisse/builddeb/giac-1.9.0
abs_top_builddir = /home/parisse/builddeb/giac-1.9.0
abs_top_srcdir = /home/parisse/builddeb/giac-1.9.0
ac_ct_CC = 
ac_ct_CXX = 
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/parisse/builddeb/giac-1.9.0/config/install-sh
